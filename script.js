...
function productlist1() {
    ...
    var options = ["--Please choose an option--", "Apple", "Samsung", "Vivo", "Xiaomi"];
...
function change() {
    ...
    document.getElementById("sbj").value = "Enquiry on " + sessionStorage.product;
    modelUpdate(product);
}
function modelChange() {
    var productModel = document.getElementById("model").value;
    sessionStorage.item_id = productModel;
    document.getElementById("sbj").value = "Enquiry on " + sessionStorage.product + " " + sessionStorage.item_id;
}

function modelUpdate(brand) {
...
function validateName() {
    ...
    var letters = /^[A-Za-z]+$/;
    if ((name == "") || !name.match(letters) || name.length > 25)
        return "Please key in your valid name\n";
    else
        return "";
}
function validateLastName() {
    ...
    var letters = /^[A-Za-z]+$/;
    if ((name == "") || !name.match(letters) || name.length > 25)
        return "Please key in your valid last name\n";
    else
        return "";
}
function validatePhoneNumber() {
    var phoneno = /^[-+]?[0-9]+$/ //check only numbers
...
function validateEmail() {
    ...
    if (email.match(mailformat))
        ...
        return "Please key in correct email\n";
}

function validateSubject() {
    var subject = document.getElementById("sbj").value;
    if (subject == "")
        return "Please key in a subject\n";
    else
        return "";
}
...
function validateMessage() {
    ...
    if (message == "")
        return "Please key in any comment\n";
    else
        return "";
}
